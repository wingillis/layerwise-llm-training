...
for split_name in ["train", "val"]:
    ...
    with autocast_ctx:
        result = evaluate_bpb(model, loader, steps, token_bytes)
    bpb = result["bpb"]
    perplexity = result["perplexity"]
    print0(f"{split_name} bpb: {bpb:.4f}, perplexity: {perplexity:.4f}")
    bpb_results[split_name] = bpb
    perplexity_results[split_name] = perplexity
    ...
    data=[
        {
            ...
            "train perplexity": perplexity_results["train"],
            "val perplexity": perplexity_results["val"],
        },
